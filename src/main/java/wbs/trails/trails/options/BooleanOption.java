...
import wbs.trails.menus.build.options.BooleanOptionSlot;
...
public class BooleanOption<T> extends ConfigOption<T, Boolean> {
    ...
    @Override
    public ConfigOptionSlot<T, Boolean> newSlot() {
        return new BooleanOptionSlot<>(WbsTrails.getInstance(), this);
    }
}
